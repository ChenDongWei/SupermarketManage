...
public class Customer {
	...
	private String khno; // 供货商编号 动态生成
	private String name; // 供货商名称
	private String area; // 供货商地区
	private String cusManager; // 供货商经理
	private String level; // 供货商等级
	private String myd; // 供货商满意度
	private String xyd; // 供货商信用度
	...
	private int state; // 供货商状态 0 正常  1 供货商流失
